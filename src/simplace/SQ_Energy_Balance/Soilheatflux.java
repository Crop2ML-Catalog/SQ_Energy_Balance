...
public class Soilheatflux extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("snetRadiationEquivalentEvaporation", "net Radiation Equivalent Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 5000, 638.142, this));
        addVariable(FWSimVariable.createSimVariable("ssoilEvaporation", "soil Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 10000, 448.240, this));
        addVariable(FWSimVariable.createSimVariable("rsoilHeatFlux", "soil Heat Flux ", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, null, this));
