...
public class Netradiation extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("calbedoCoefficient", "albedo Coefficient", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 0.23, this));
        addVariable(FWSimVariable.createSimVariable("cstefanBoltzman", "stefan Boltzman constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 4.903E-09, this));
        addVariable(FWSimVariable.createSimVariable("celevation", "elevation", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", -500, 10000, 0, this));
        ...
        addVariable(FWSimVariable.createSimVariable("isolarRadiation", "solar Radiation", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 1000, 3, this));
        addVariable(FWSimVariable.createSimVariable("ivaporPressure", "vapor Pressure", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 1000, 6.1, this));
        addVariable(FWSimVariable.createSimVariable("iextraSolarRadiation", "extra Solar Radiation", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 1000, 11.7, this));
