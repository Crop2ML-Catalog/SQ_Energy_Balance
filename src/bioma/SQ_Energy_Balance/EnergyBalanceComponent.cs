...
namespace EnergyBalance.Strategies
{
    public class EnergyBalanceComponent : IStrategyEnergyBalance
    {
        public EnergyBalanceComponent()
        {
            ...
            pd7.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.plantHeight).ValueType.TypeForCurrentValue;
            pd7.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.plantHeight);
            _inputs0_0.Add(pd7);
            PropertyDescription pd8 = new PropertyDescription();
            pd8.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd8.PropertyName = "wind";
            pd8.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.wind).ValueType.TypeForCurrentValue;
            pd8.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.wind);
            _inputs0_0.Add(pd8);
            PropertyDescription pd9 = new PropertyDescription();
            pd9.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd9.PropertyName = "deficitOnTopLayers";
            pd9.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.deficitOnTopLayers).ValueType.TypeForCurrentValue;
            pd9.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.deficitOnTopLayers);
            _inputs0_0.Add(pd9);
            PropertyDescription pd10 = new PropertyDescription();
            pd10.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd10.PropertyName = "VPDair";
            pd10.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.VPDair).ValueType.TypeForCurrentValue;
            pd10.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.VPDair);
            _inputs0_0.Add(pd10);
            ...
            pd11.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiation).ValueType.TypeForCurrentValue;
            pd11.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiation);
            ...
            pd12.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netOutGoingLongWaveRadiation).ValueType.TypeForCurrentValue;
            pd12.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netOutGoingLongWaveRadiation);
            _outputs0_0.Add(pd12);
            PropertyDescription pd13 = new PropertyDescription();
            pd13.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd13.PropertyName = "netRadiationEquivalentEvaporation";
            pd13.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiationEquivalentEvaporation).ValueType.TypeForCurrentValue;
            pd13.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiationEquivalentEvaporation);
            _outputs0_0.Add(pd13);
            PropertyDescription pd14 = new PropertyDescription();
            pd14.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceRate);
            pd14.PropertyName = "evapoTranspirationPriestlyTaylor";
            pd14.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPriestlyTaylor).ValueType.TypeForCurrentValue;
            pd14.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPriestlyTaylor);
            _outputs0_0.Add(pd14);
            PropertyDescription pd15 = new PropertyDescription();
            pd15.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceState);
            pd15.PropertyName = "diffusionLimitedEvaporation";
            pd15.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.diffusionLimitedEvaporation).ValueType.TypeForCurrentValue;
            pd15.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.diffusionLimitedEvaporation);
            _outputs0_0.Add(pd15);
            PropertyDescription pd16 = new PropertyDescription();
            pd16.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd16.PropertyName = "energyLimitedEvaporation";
            pd16.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.energyLimitedEvaporation).ValueType.TypeForCurrentValue;
            pd16.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.energyLimitedEvaporation);
            _outputs0_0.Add(pd16);
            PropertyDescription pd17 = new PropertyDescription();
            pd17.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceState);
            pd17.PropertyName = "conductance";
            pd17.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance).ValueType.TypeForCurrentValue;
            pd17.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance);
            ...
            pd18.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPenman).ValueType.TypeForCurrentValue;
            pd18.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPenman);
            _outputs0_0.Add(pd18);
            PropertyDescription pd19 = new PropertyDescription();
            pd19.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceAuxiliary);
            pd19.PropertyName = "soilEvaporation";
            pd19.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.soilEvaporation).ValueType.TypeForCurrentValue;
            pd19.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.soilEvaporation);
            ...
            pd20.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspiration).ValueType.TypeForCurrentValue;
            pd20.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspiration);
            ...
            pd21.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.potentialTranspiration).ValueType.TypeForCurrentValue;
            pd21.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.potentialTranspiration);
            _outputs0_0.Add(pd21);
            PropertyDescription pd22 = new PropertyDescription();
            pd22.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceRate);
            pd22.PropertyName = "soilHeatFlux";
            pd22.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.soilHeatFlux).ValueType.TypeForCurrentValue;
            pd22.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.soilHeatFlux);
            _outputs0_0.Add(pd22);
            PropertyDescription pd23 = new PropertyDescription();
            pd23.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceRate);
            pd23.PropertyName = "cropHeatFlux";
            pd23.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.cropHeatFlux).ValueType.TypeForCurrentValue;
            pd23.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.cropHeatFlux);
            _outputs0_0.Add(pd23);
            PropertyDescription pd24 = new PropertyDescription();
            pd24.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceState);
            pd24.PropertyName = "minCanopyTemperature";
            pd24.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.minCanopyTemperature).ValueType.TypeForCurrentValue;
            pd24.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.minCanopyTemperature);
            _outputs0_0.Add(pd24);
            PropertyDescription pd25 = new PropertyDescription();
            pd25.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceState);
            pd25.PropertyName = "maxCanopyTemperature";
            pd25.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.maxCanopyTemperature).ValueType.TypeForCurrentValue;
            pd25.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.maxCanopyTemperature);
            ...
            lAssStrat0_0.Add(typeof(EnergyBalance.Strategies.Conductance).FullName);
        ...
        {
            get { return EnergyBalance.Strategies.Conductance.vonKarmanVarInfo;} 
        }

        public static VarInfo heightWeatherMeasurementsVarInfo
        {
            get { return EnergyBalance.Strategies.Conductance.heightWeatherMeasurementsVarInfo;} 
        }

        public static VarInfo zmVarInfo
        {
            get { return EnergyBalance.Strategies.Conductance.zmVarInfo;} 
        }

        public static VarInfo dVarInfo
        {
            get { return EnergyBalance.Strategies.Conductance.dVarInfo;} 
        }

        public static VarInfo zhVarInfo
        {
            get { return EnergyBalance.Strategies.Conductance.zhVarInfo;} 
        }
        ...
        public string TestPostConditions(EnergyBalance.DomainClass.EnergyBalanceState s,EnergyBalance.DomainClass.EnergyBalanceState s1,EnergyBalance.DomainClass.EnergyBalanceRate r,EnergyBalance.DomainClass.EnergyBalanceAuxiliary a,EnergyBalance.DomainClass.EnergyBalanceExogenous ex,string callID)
        {
            try
            {
                ...
                EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance.CurrentValue=s.conductance;
                ...
                RangeBasedCondition r28 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiation);
                if(r28.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiation.ValueType)){prc.AddCondition(r28);}
                RangeBasedCondition r29 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netOutGoingLongWaveRadiation);
                if(r29.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netOutGoingLongWaveRadiation.ValueType)){prc.AddCondition(r29);}
                RangeBasedCondition r30 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiationEquivalentEvaporation);
                if(r30.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.netRadiationEquivalentEvaporation.ValueType)){prc.AddCondition(r30);}
                RangeBasedCondition r31 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPriestlyTaylor);
                if(r31.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPriestlyTaylor.ValueType)){prc.AddCondition(r31);}
                RangeBasedCondition r32 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.diffusionLimitedEvaporation);
                if(r32.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.diffusionLimitedEvaporation.ValueType)){prc.AddCondition(r32);}
                RangeBasedCondition r33 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.energyLimitedEvaporation);
                if(r33.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.energyLimitedEvaporation.ValueType)){prc.AddCondition(r33);}
                RangeBasedCondition r34 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance);
                if(r34.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance.ValueType)){prc.AddCondition(r34);}
                RangeBasedCondition r35 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPenman);
                if(r35.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspirationPenman.ValueType)){prc.AddCondition(r35);}
                RangeBasedCondition r36 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.soilEvaporation);
                if(r36.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.soilEvaporation.ValueType)){prc.AddCondition(r36);}
                RangeBasedCondition r37 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspiration);
                if(r37.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.evapoTranspiration.ValueType)){prc.AddCondition(r37);}
                RangeBasedCondition r38 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.potentialTranspiration);
                if(r38.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.potentialTranspiration.ValueType)){prc.AddCondition(r38);}
                RangeBasedCondition r39 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.soilHeatFlux);
                if(r39.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.soilHeatFlux.ValueType)){prc.AddCondition(r39);}
                RangeBasedCondition r40 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.cropHeatFlux);
                if(r40.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceRateVarInfo.cropHeatFlux.ValueType)){prc.AddCondition(r40);}
                RangeBasedCondition r41 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.minCanopyTemperature);
                if(r41.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.minCanopyTemperature.ValueType)){prc.AddCondition(r41);}
                RangeBasedCondition r42 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.maxCanopyTemperature);
                if(r42.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.maxCanopyTemperature.ValueType)){prc.AddCondition(r42);}
                ...
                ret += _Conductance.TestPostConditions(s, s1, r, a, ex, " strategy EnergyBalance.Strategies.EnergyBalance");
        ...
        public string TestPreConditions(EnergyBalance.DomainClass.EnergyBalanceState s,EnergyBalance.DomainClass.EnergyBalanceState s1,EnergyBalance.DomainClass.EnergyBalanceRate r,EnergyBalance.DomainClass.EnergyBalanceAuxiliary a,EnergyBalance.DomainClass.EnergyBalanceExogenous ex,string callID)
        {
            try
            {
                ...
                EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.plantHeight.CurrentValue=a.plantHeight;
                EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.wind.CurrentValue=a.wind;
                ...
                RangeBasedCondition r7 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.plantHeight);
                if(r7.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.plantHeight.ValueType)){prc.AddCondition(r7);}
                RangeBasedCondition r8 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.wind);
                if(r8.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.wind.ValueType)){prc.AddCondition(r8);}
                RangeBasedCondition r9 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.deficitOnTopLayers);
                if(r9.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.deficitOnTopLayers.ValueType)){prc.AddCondition(r9);}
                RangeBasedCondition r10 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.VPDair);
                if(r10.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceAuxiliaryVarInfo.VPDair.ValueType)){prc.AddCondition(r10);}
                ...
                ret += _Conductance.TestPreConditions(s, s1, r, a, ex, " strategy EnergyBalance.Strategies.EnergyBalance");
