...
public class Penman extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("cpsychrometricConstant", "psychrometric constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 0.66, this));
        addVariable(FWSimVariable.createSimVariable("cAlpha", "Priestley-Taylor evapotranspiration proportionality constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 100, 1.5, this));
        ...
        addVariable(FWSimVariable.createSimVariable("cspecificHeatCapacityAir", "Specific heat capacity of dry air", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 0.00101, this));
        addVariable(FWSimVariable.createSimVariable("ihslope", "the slope of saturated vapor pressure temperature curve at a given temperature ", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 1000, 0.584, this));
        addVariable(FWSimVariable.createSimVariable("iVPDair", " vapour pressure density", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 1000, 2.19, this));
        addVariable(FWSimVariable.createSimVariable("sconductance", "conductance", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 10000, 598.685, this));
        addVariable(FWSimVariable.createSimVariable("revapoTranspirationPriestlyTaylor", "evapoTranspiration of Priestly Taylor ", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, 449.367, this));
        addVariable(FWSimVariable.createSimVariable("revapoTranspirationPenman", " evapoTranspiration of Penman Monteith", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 5000, null, this));
