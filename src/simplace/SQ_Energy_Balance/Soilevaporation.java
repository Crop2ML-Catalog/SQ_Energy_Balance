...
public class Soilevaporation extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("sdiffusionLimitedEvaporation", "diffusion Limited Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 10000, 6605.505, this));
        addVariable(FWSimVariable.createSimVariable("senergyLimitedEvaporation", "energy Limited Evaporation", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 1000, 448.240, this));
