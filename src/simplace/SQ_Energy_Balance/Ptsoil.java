...
public class Ptsoil extends FWSimComponent
{
    ...
    public HashMap<String, FWSimVariable<?>> createVariables()
    {
        ...
        addVariable(FWSimVariable.createSimVariable("ctau", "plant cover factor", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 100, 0.9983, this));
        addVariable(FWSimVariable.createSimVariable("ctauAlpha", "Fraction of the total net radiation exchanged at the soil surface when AlpaE = 1", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 0.3, this));
        ...
        addVariable(FWSimVariable.createSimVariable("revapoTranspirationPriestlyTaylor", "evapoTranspiration Priestly Taylor", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 1000, 120, this));
