...
public class Potentialtranspiration extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("ctau", "plant cover factor", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 1, 0.9983, this));
        addVariable(FWSimVariable.createSimVariable("revapoTranspiration", "evapoTranspiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, 830.958, this));
        addVariable(FWSimVariable.createSimVariable("rpotentialTranspiration", "potential Transpiration ", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, null, this));
