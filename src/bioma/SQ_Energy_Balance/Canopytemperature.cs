...
namespace EnergyBalance.Strategies
{
    public class CanopyTemperature : IStrategyEnergyBalance
    {
        public CanopyTemperature()
        {
            ...
            pd4.DomainClassType = typeof(EnergyBalance.DomainClass.EnergyBalanceState);
            pd4.PropertyName = "conductance";
            pd4.PropertyType = (EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance).ValueType.TypeForCurrentValue;
            pd4.PropertyVarInfo =(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance);
            _inputs0_0.Add(pd4);
        ...
        public string TestPreConditions(EnergyBalance.DomainClass.EnergyBalanceState s,EnergyBalance.DomainClass.EnergyBalanceState s1,EnergyBalance.DomainClass.EnergyBalanceRate r,EnergyBalance.DomainClass.EnergyBalanceAuxiliary a,EnergyBalance.DomainClass.EnergyBalanceExogenous ex,string callID)
        {
            try
            {
                ...
                RangeBasedCondition r4 = new RangeBasedCondition(EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance);
                if(r4.ApplicableVarInfoValueTypes.Contains( EnergyBalance.DomainClass.EnergyBalanceStateVarInfo.conductance.ValueType)){prc.AddCondition(r4);}
