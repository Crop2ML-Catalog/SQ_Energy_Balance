...
public class Diffusionlimitedevaporation extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("csoilDiffusionConstant", "soil Diffusion Constant", DATA_TYPE.DOUBLE, CONTENT_TYPE.constant,"", 0, 10, 4.2, this));
        addVariable(FWSimVariable.createSimVariable("ideficitOnTopLayers", "deficit On TopLayers", DATA_TYPE.DOUBLE, CONTENT_TYPE.input,"", 0, 10000, 5341, this));
        addVariable(FWSimVariable.createSimVariable("sdiffusionLimitedEvaporation", "the evaporation from the diffusion limited soil ", DATA_TYPE.DOUBLE, CONTENT_TYPE.state,"", 0, 5000, null, this));
