...
public class Evapotranspiration extends FWSimComponent
{
    ...
    {
        addVariable(FWSimVariable.createSimVariable("cisWindVpDefined", "if wind and vapour pressure are defined", DATA_TYPE.INT, CONTENT_TYPE.constant,"", 0, 1, 1, this));
        ...
        addVariable(FWSimVariable.createSimVariable("revapoTranspirationPenman", "evapoTranspiration of Penman ", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, 830.958, this));
        addVariable(FWSimVariable.createSimVariable("revapoTranspiration", "evapoTranspiration", DATA_TYPE.DOUBLE, CONTENT_TYPE.rate,"", 0, 10000, null, this));
